...
// The username must contain at least one uppercase letter, at least one lowercase letter, and at least one number

const USER_REGEX = /^[a-zA-Z][a-zA0-9-_]{3,23}$/;

// The password must contain a lowercase letter, an uppercase letter, a number, and an emoji
    ...
    <section>
        ...
        <form onSubmit={handelSubmit} >
            ...
            >
                ...
                </span><span aria-label='at symbol'>@</span><span aria-label='hashtag' >#</span> <span aria-label='dollar sign' >$</span> <span aria-label='percent' >%</span>
